...
public class PacRuchira extends JFrame implements ActionListener {
   ...
   public void init() {
      ...
      add(btnExit);
      setVisible(true);     
      File soundFile =  new File("src/minah.wav").getAbsoluteFile();
      try {
